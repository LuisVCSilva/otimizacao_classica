...
def reduz_intervalo(func, xa=0.0, xb=1.0, max_cresc=110.0, maxiter=1000):
...
def minimiza_secao_aurea (func, xa, xb, xc, xtol=0.001, maxiter=5000):
    ...
    tol = xtol
    avaliacoesFO = 0
    conjSecaoAurea = 0.61803399 #conjugado da razao aurea
    ...
    for i in xrange(maxiter):
        ...
        #print({"a":x0,"b":x1,"c":x2,"_xmin":xmin,"ymin":ymin})
    return xmin
